...
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;1,100&family=Pacifico&display=swap" rel="stylesheet"> 
...
<body>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2022 BossMall. All rights reserved.</p>
	...
	<script src="<?php echo base_url()?>assets/front/js/price-range.js?<?php echo time() ?>"></script>
	<script src="<?php echo base_url()?>assets/front/js/jquery.prettyPhoto.js?<?php echo time() ?>"></script>
	<script src="<?php echo base_url()?>assets/front/js/main.js?<?php echo time() ?>"></script>
</body>
</html>